        ...
        <div className='bg-[#262B3F] text-white py-16'>
            ...
            <div className='flex flex-wrap justify-center gap-4 md:gap-8 xl:w-[1280px] m-auto py-10'>
                ...
                <div className='relative group w-4/5 sm:w-[300px] h-full overflow-hidden' key={index}>   
                        <Image src={item.src} alt='My Image' layout='responsive' width={300} height={400}
                        ...
                        <h4 data-aos="fade-right" className='absolute inset-0 p-2 z-10 flex items-start justify-center opacity-100 ease-in-out group-hover:scale-90 transition-opacity duration-300'>{item.h3}</h4>

                        <p className='absolute inset-0 z-10 opacity-0 group-hover:opacity-100 translate-x-full group-hover:translate-x-0 transition-all duration-300 flex items-center p-2'>{item.h4}</p>
