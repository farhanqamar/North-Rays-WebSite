...
const Footer = () => {
  return (
    <div className="bg-[#151922] grid grid:cols-1 sm:grid-cols-2 md:grid-cols-4 items-center border text-left border-gray-400">
      <div className=" text-white p-20 text-left flex justify-center md:flex-col">
        <div className="">
        <Image
          src={logo} // Image path
        ...
        <p className="text-[14px] leading-8 hidden md:block tracking-wide text-[#6b6b6e]">
